...
public class GCNlang {
    ...
    public static void main(String[] args){
		...
		ModelBuilder modelBuilder = new LangBuilder()
				.config("features", dataset.features().getCols())
				.config("classes", 0.005)
				.parse("fn gcnlayer(A, h, hidden=64, reg=0.005) {"
