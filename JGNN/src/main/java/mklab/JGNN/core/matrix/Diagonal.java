...
/**
 * Implements a square matrix whose diagonal elements are determined by the
 * correspond values of an underlying tensor and off-diagonal elements are zero.
 * Elements are shared between the matrix and its diagonal tensor. This
 * structure is similar to a sparse matrix.
 * 
