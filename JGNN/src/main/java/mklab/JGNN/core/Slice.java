...
public class Slice implements Iterable<Long> {
	 ...
	 * @param end The end (non-inclusive) of the identifiers' position in the slice. 
	 * @return A new Slice instance holding the position identifiers in this one's given range.
	 * 
