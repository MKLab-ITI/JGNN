...
/**
 * This class provides {@link Tensor} whose elements are all equal. Due to
 * uncertain usage, its {@link #put(long, double)} operation is unsupported and
 * throws a corresponding exception. Otherwise, instances of this class behave
 * similarly to {@link DenseTensor} but permanently allocate only O(1) memory.
 * 
