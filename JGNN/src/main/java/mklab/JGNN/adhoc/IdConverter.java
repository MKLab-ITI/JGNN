...
public class IdConverter {
	...
	/**
	 * Instantiates an empty converter to be filled with
	 * {@link #getOrCreateId(Object)}.
	 */
	public IdConverter() {
	}

	/**
	 * Instantiates the converter on a list of objects to register with
	 * {@link #getOrCreateId(Object)} on.
	 * 
	 ...
	 * 
	 * @param nodeDimensionName    The dimension name for traversing nodes (e.g.
	 *                             "node").
	 * @param featureDimensionName The dimension name for traversing features (e.g.
	 *                             "label").
	...
	/**
	 * Returns a slice of all registered identifiers. The slice is persistent across
	 * multiple calls to this method, but is instantiated anew after
	 * {@link #getOrCreateId(Object)} registers a new object (but not if it
